...
#this should be done somewhere else in the package maybe need to re-do git commands
library(data.table) 
library(tidyr)
library(dplyr)
library(readr)
...
gene_trans <- system.file("data", "gencode_v41_gene-transcript-convert.txt", package="isoviz")
