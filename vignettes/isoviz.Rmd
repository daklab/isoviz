...
junctions <- system.file("data", "hESC.junc", package="isoviz")

# junction files also available for A375 and HEK293
# junctions <- system.file("data", "A375.junc", package="isoviz")
# junctions <- system.file("data", "HEK293.junc", package="isoviz")
